...
def crop_images(file_name: str) -> List[str]:
    ...
    for factor in ScaledFactors.factors:
        ...
        base_image.crop(
            (offset_x, offset_y, delta_x + offset_x, delta_y + offset_y)).save(part_name)
        small_images_file_names.append(part_name)
